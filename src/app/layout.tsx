  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisiosalud-daniel-moreno";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisiosalud Daniel Moreno"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisiosalud-daniel-moreno"
          data-primary-color="#0496ea"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="fisiosalud-daniel-moreno";
